...
//     e.preventDefault();
//     try {
//       const res = await axios.post('/api/v2/auth/register', ///api/v2/auth
...
//           <div className="mb-3">
//             <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="form-container" id="exampleInputEmail1" placeholder="Enter Your Name" required />
//           </div>
//           <div className="mb-3">
